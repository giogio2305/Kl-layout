...
import { ChevronDownIcon,ChevronUpIcon,PhoneIcon,PlusIcon,VideoCameraIcon,XIcon } from '@heroicons/react/solid'
    ...
    <> 
                            {
                              chatReduce  
                              ?
                              <div className='fixed flex flex-col items-center justify-start rounded shadow-lg bottom-0 right-24 mb-1 w-[348px] h-10 flex flex-col items-center bg-white'>
        
                              <div className='flex items-center justify-start w-[100%] h-10 rounded bg-[#005b82] px-1'>
                                  
                                  <div className='inline-flex items-center justify-center mr-12 ml-2'>
                                  <div  className='mx-2   d-flex justify-center items-center text-center  w-2 h-2 rounded-full bg-[#e80c00] cursor-pointer' ></div>
                                      <div className='text-[15.5px] text-white font-semibold w-[140px] truncate '>Cabraule Ketchanga</div>
                                  </div>
                        ...
                        <PhoneIcon className='h-5 w-5 text-white cursor-pointer ml-2' onClick={()=>setChatReduce(!chatReduce)}/>
                        <VideoCameraIcon className='h-5 w-5 text-white cursor-pointer ml-2' onClick={()=>setChatReduce(!chatReduce)}/>
                    <XIcon className='h-5 w-5 text-white ml-2 cursor-pointer' onClick={()=>setChatBox(!chatBox)}/>
                              ...
                              <div className='fixed flex flex-col items-center justify-start rounded shadow-lg bottom-0 right-24 mb-1 w-[348px] h-[455px] flex flex-col items-center bg-white'>
