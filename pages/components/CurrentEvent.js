...
function CurrentEvent() {
  ...
  return (
    ...
    <h3 class="mb-1 text-base font-semibold text-[#005b82]">Créer un Evènement</h3>
...
<div class="modal">
  <div class="modal-box relative bg-white w-[694px] h-[644px] rounded no-scrollbar">
    ...
    <Kicon />
    <h3 class="ml-8 text-2xl font-medium text-slate-600">Créer un Evènement</h3>
    </div>

        
    <div className='flex flex-col items-start justify-start m-4'>
        <p className="py-4 text-sm font-medium">Nom de l'évènement</p>
        ...
        <div className="py-4 text-sm font-medium">Description de l'évènement</div>
        ...
        <div className="py-4 text-sm font-medium">Date de debut *</div>
        ...
        <div className="py-4 text-sm font-medium">Date de fin *</div>
        <input type="text" class="text-sm font-medium   w-[207px] input input-bordered   rounded-lg bg-white border border-1 border-slate-300"></input>
        </div>
        </div>
      ...
      >
        ...
        <div className='flex flex-col items-start justify-start m-4'>
        <p className="py-4 text-sm font-medium">Adresse de l'évènement</p>
        <input type="text" class="text-sm font-medium   w-[422px] input input-bordered   rounded-lg bg-white border border-1 border-slate-300"></input>
