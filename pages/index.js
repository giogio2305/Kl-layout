...
return (
  <div className='fixed float-left h-[100%]'> 
  <div className='bg-orange-500 text-blue-600 w-20 md:no-scrollbar h-[640px] overflow-y-auto overflow-x-hidden '>
  ...
  <Image
    ...
    <nav >
    <div  className='m-6 cursor-pointer' onClick={()=>setSideOpen(true)} data-tooltip-target={`tooltip-menu`} data-tooltip-trigger="hover" data-tooltip-placement="right"  >
  ...
  return (
      <div className='flex items-start justify-start overflow-y-hidden'>
      {
        sideOpen 
         ?
         <OsideBar />
